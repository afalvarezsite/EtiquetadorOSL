    ...
    <div class="main-content">
        ...
        <div class="card">
            <form method="post" action="<?php echo $this->esc(BASE_URL); ?>admin/gpu">
                <input type="hidden" name="csrf_token" value="<?php echo $this->esc($csrf_token); ?>">
                <div class="admin-form-row">
                    <input type="search" name="pattern" placeholder="Buscar GPU..."
                                ...
                                <tr>
                                    ...
                                    <td class="actions">
                                        <button class="btn btn-edit"
                                            onclick='editGPU(<?php echo (int) $gpu['id']; ?>, <?php echo htmlspecialchars(json_encode($gpu['name']), ENT_QUOTES, 'UTF-8'); ?>)'>Editar</button>
                                        <a href="<?php echo $this->esc(BASE_URL); ?>admin/gpu?delete=<?php echo $this->esc($gpu['id']); ?>"
        ...
        <?php if (!empty($gpus)): ?>
            ...
            <div class="danger-zone">
                ...
                <div class="danger-zone-content">
                    ...
                    <form id="deleteAllForm" method="post" action="<?php echo $this->esc(BASE_URL); ?>admin/gpu"
                        style="display:none;">
                        <input type="hidden" name="csrf_token" value="<?php echo $this->esc($csrf_token); ?>">
                        <input type="hidden" name="deleteAll" value="1">
                    </form>
                    <button type="button" class="btn-danger-premium"
                        onclick="confirmMassDeletion('todas las GPUs', 'deleteAllForm')">
